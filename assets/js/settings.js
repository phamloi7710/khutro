var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
	    +'<div class="ts-title">Giao Diện</div>'
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="http://nhatro.lo/assets/admin/css/theme-default.css"><img src="http://nhatro.lo/assets/admin/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="http://nhatro.lo/assets/admin/css/theme-brown.css"><img src="http://nhatro.lo/assets/admin/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="http://nhatro.lo/assets/admin/css/theme-blue.css"><img src="http://nhatro.lo/assets/admin/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="http://nhatro.lo/assets/admin/css/theme-white.css"><img src="http://nhatro.lo/assets/admin/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="http://nhatro.lo/assets/admin/css/theme-black.css"><img src="http://nhatro.lo/assets/admin/img/themes/black.jpg"/></a>'
        +'</div>'
		+'<div class="ts-title">Bố Cục</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0" checked/> Chiều Rộng Đầy Đủ</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> Đóng Hộp</label>'
        +'</div>'
        +'<div class="ts-title">Một Số Lựa Chọn</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/> Tiêu Đề Cố Định</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> Menu Cố Định</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> Menu Di Chuyển</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> Menu Phía Bên Phải</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> Điều Hướng Tuỳ Chỉnh</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> Ẩn Menu</label>'
        +'</div>'
